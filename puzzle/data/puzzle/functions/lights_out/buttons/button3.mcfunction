...
execute if entity @e[tag=lo_button2,type=block_display,nbt={"block_state":{"Name":"minecraft:black_concrete"}}] run tag @e[tag=lo_button2,type=block_display,nbt={"block_state":{"Name":"minecraft:black_concrete"}}] add lo_tmp
execute if entity @e[tag=lo_button2,type=block_display,nbt={"block_state":{"Name":"minecraft:yellow_concrete"}}] run data modify entity @e[tag=lo_button2,type=minecraft:block_display,limit=1] block_state.Name set value "black_concrete"
data modify entity @e[tag=lo_button2,tag=lo_tmp,type=minecraft:block_display,limit=1] block_state.Name set value "yellow_concrete"
...
execute if entity @e[tag=lo_button3,type=block_display,nbt={"block_state":{"Name":"minecraft:yellow_concrete"}}] run data modify entity @e[tag=lo_button3,type=minecraft:block_display,limit=1] block_state.Name set value "black_concrete"
...
execute if entity @e[tag=lo_button8,type=block_display,nbt={"block_state":{"Name":"minecraft:yellow_concrete"}}] run data modify entity @e[tag=lo_button8,type=minecraft:block_display,limit=1] block_state.Name set value "black_concrete"
