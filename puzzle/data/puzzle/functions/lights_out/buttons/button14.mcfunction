...
execute if entity @e[tag=lo_button9,type=block_display,nbt={"block_state":{"Name":"minecraft:yellow_concrete"}}] run data modify entity @e[tag=lo_button9,type=minecraft:block_display,limit=1] block_state.Name set value "black_concrete"
